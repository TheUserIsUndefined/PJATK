...
class CompanionAnimal(BaseAnimal):
    ...
    # Initializes a companion animal with specific parameters and default boredom and hunger rates
    ...
    # Reduces boredom per click interaction
    def play_click(self):
        self.boredom = max(0, self.boredom - self.BOREDOM_DECREASE_PER_CLICK)

    # Updates hunger, applying multiplier if bored
    ...
    # Updates death timer based on hunger status
